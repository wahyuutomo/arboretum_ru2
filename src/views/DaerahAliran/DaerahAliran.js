        ...
        <Container fluid style={{background: '#fff'}}>
          <Row>
            ...
            <Col >
              ...
              {/* FLORA TABLE */}
              <DataTable data={table_data.flora} data_count={table_data.data_count.flora} years={[2023]}/>
              ...
              <Row style={{paddingTop: 30}}>
                <Col style={{textAlign: 'center'}}>
                  <h5>Indeks Keanekaragaman Hayati Flora Konservasi Daerah Aliran</h5>
                  <Table striped bordered hover size="sm">
                    <thead>
                      <tr>
                        <th></th>
              ...
              {/* BIRDS TABLE */}
              <DataTable data={table_data.birds} data_count={table_data.data_count.birds} years={[2023]}/>
              ...
              {/* MAMMALS TABLE */}
              <DataTable data={table_data.mammals} data_count={table_data.data_count.mammals} years={[2023]}/>
              ...
              {/* HERPETOFAUNA TABLE */}
              <DataTable data={table_data.herpetofauna} data_count={table_data.data_count.herpetofauna} years={[2023]}/>
              ...
              <Row style={{paddingTop: 45}}>
                ...
                <Col style={{textAlign: 'center'}}>
                  ...
                  <Table striped bordered hover size="sm">
                    ...
                    <tbody>
                      {table_data.hre_index.herpetofauna.map(( listValue, index ) => {
                        return (
                          <tr key={index}>
                            <td style={{textAlign: 'center'}}>{listValue.x}</td>
                            <td style={{textAlign: 'center'}}>{listValue.h}</td>
