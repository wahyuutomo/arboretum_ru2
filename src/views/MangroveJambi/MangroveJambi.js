          ...
          <Col>
            ...
            <Row style={{ paddingTop: 45 }}>
              ...
              <Col md={8} style={{ textAlign: "center" }}>
                <div>
                  <h5>
                    Diagram Indeks Ekologi Herpetofauna Tahun 2022 dan 2024 di
                    Mangrove Education Center Pangkalan Jambi: Indeks
                    Keanekaragaman Jenis (H’); Indeks Kekayaan Jenis (R); Indeks
                    Kemerataan (E)
                  </h5>
                  <XYPlot
                  ...
                  >
                    ...
                    <LabelSeries
                      labelAnchorX="middle"
                      data={[
                        { x: "H'", y: 1.2, yOffset: -25, xOffset: -45 },
                        { x: "R", y: 2.06, yOffset: -25, xOffset: -45 },
                        { x: "E", y: 0.81, yOffset: -25, xOffset: -45 },
                      ]}
                      getLabel={(d) => d.y}
                    />
...
export default connect(mapStateToProps)(MangroveJambi);
