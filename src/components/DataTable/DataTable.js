          ...
          <Table striped bordered hover size="sm">
            <thead>
              <tr>
                ...
                <th colspan={years.length} style={{ textAlign: "center" }}>
                  Jumlah
                </th>
              </tr>
              <tr>
                {years.map((year) => {
                  return <td style={{ textAlign: "center" }}>{year}</td>;
                })}
              </tr>
            </thead>
            <tbody>
              ...
              <tr>
                ...
                {data_count.map((listValue, index) => {
                  return <td style={{ textAlign: "center" }}>{listValue.y}</td>;
                })}
              </tr>
            </tbody>
          </Table>
