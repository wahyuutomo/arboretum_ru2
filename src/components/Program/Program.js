...
import poligowo2 from "../../assets/poligowo2.jpeg";
import poligowo1 from "../../assets/20.jpeg";
    ...
    return (
      <Row>
        ...
        <Col style={{ background: "#fff" }}>
          ...
          >
            <Card.Img variant="top" src={poligowo2} height="240" />
            <Card.Body className="text-center">
        ...
        <Col style={{ background: "#fff" }}>
          ...
          >
            ...
            <Card.Body className="text-center">
              <Card.Title>Edu Wisata Lebah Madu Tanjung Leban</Card.Title>
            </Card.Body>
          </Card>
        </Col>
      </Row>
